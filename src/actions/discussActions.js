...
export const searchFriends = (searchItem) => dispatch => {
  dispatch(setSearchLoading());
  axios.post('/main/discuss/search', searchItem)
  .then(res => dispatch({
    type: SEARCH_FRIENDS,
    payload: res.data
  }))
...
export const getFriends = () => dispatch => {
  axios.get('/main/discuss/getfriend')
  .then(res => dispatch({
    type: GET_FRIENDS,
    payload: res.data
  }))
...
export const inviteFriend = (item) => dispatch => {
  axios.post('/main/discuss/invite', item) 
  .then(res => dispatch({
    type: INVITE_FRIEND,
    payload: res.data
  }))
